...
SPARQLPATH = "http://172.16.2.232:8890/sparql"  # depend on your own internal address and port, shown in Freebase folder's readme.md
...
def prepare_dataset_for_eval(dataset_name, output_file):
    if dataset_name == 'cwq':
        ...
        with open('../../data/grailqa_dev.json', encoding='utf-8') as f:
            datas = json.load(f)
        question_string = 'question'
