...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_file", type=str,
                        default=r"PoG_0708/PoG_webqsp_gpt-4o-mini-2024-07-18.json",
    ...
    data_list = [output_datas[0][question_string]]
    for data in output_datas[1:]:
        if data[question_string] not in data_list:
            new_output_datas.append(data)
        data_list.append(data[question_string])
    print(len(data_list))
